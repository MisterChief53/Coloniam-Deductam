...
public class Boss extends Enemy
{
    ...
    private MyWorld w;
    public Boss(char direction, int speed){
        super(direction, speed, 2000);
        this.w = getWorldOfType(MyWorld.class);
        for(int i = 0; i < 14; i++){
            barArray[i] = new HealthBar("health" + (i+1) + ".png");
        }
        //w.addObject(barArray[0], ((MyWorld) w).HEIGHT - 10, 50);
    }
    public void act()
    {
        if(getWorld() != null){
